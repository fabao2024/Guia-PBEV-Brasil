  ...
  return (
    ...
    >
      ...
      <button 
        ...
        className={`absolute top-3 left-3 z-20 p-1.5 rounded-lg border shadow-sm transition-all ${
      ...
      >
       ...
       <button 
        ...
        className={`absolute top-3 right-3 z-20 p-1.5 rounded-lg border shadow-sm transition-all ${
            isFavorite 
