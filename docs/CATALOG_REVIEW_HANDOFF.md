...
Status: em execução; cobertura verificada em **486/763** campos com fonte oficial direta por campo. Lotes de marcas, o pareamento completo da tabela PBEV e os lotes BYD, MG Motor, Mini, GWM/Porsche/Zeekr/Neta, carros de passeio (lote A) e comerciais leves/Leapmotor (lote B) concluídos.

Documentos: matriz (`bloco5-matriz-proveniencia-2026-08-25.md`) e relatórios de lote (`lote-piloto-volvo`, `lote-marcas`, `itens-1-a-4`, `lote-pbev-consumo`, `lote-audi`, `lote-decisoes-pendentes`, `lote-gac`, `lote-geely`, `lote-jac`, `lote-kia-lexus-nissan`, `lote-peugeot-renault-audi`, `lote-pbev-final`, `lote-tracoes`, `lote-byd-fichas`, `lote-mg-motor`, `lote-mini`, `lote-gwm-porsche-zeekr-neta`, `lote-a-passeio`, `lote-b-comerciais-leapmotor`).
...
- Lote B (comerciais leves e Leapmotor): +29 verificações por campo; e-Jumpy pareada à Cargo vigente (258 km/0,75 MJ/km), C10 DC 84 kW, V6E 41,86 kWh e 6,6/41 kW, SuperVan 82,33 kWh, eWonder 6,6/41,8 kW e eView Grand atualizada para a versão 77 (R$ 329.900, 187 km, 1,00 MJ/km, 6,6/77 kW); e-Scudo descontinuada.
...
6. Retomar o Bloco 5 pela varredura final de `availability`; o lote B de comerciais leves e Leapmotor foi concluído localmente e aguarda revisão/publicação.
