...
import { X, Map, Car as CarIcon, Battery, Zap, CheckCircle2, DollarSign, ChevronLeft, ChevronRight, Image as ImageIcon, Scale, Check, Loader2, Heart } from 'lucide-react';
      ...
      <div className="bg-white w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded-3xl shadow-2xl relative z-10 animate-in fade-in zoom-in-95 duration-200 flex flex-col md:flex-row overflow-hidden ring-1 ring-slate-900/5">
        ...
        <div className="w-full md:w-1/2 p-6 md:p-10 bg-white flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
                ...
                <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-wide mb-2 flex items-center gap-1.5">
                        <Battery className="w-3.5 h-3.5" /> Propulsão
                    </p>
                    <p className="text-lg font-bold text-slate-800">100% Elétrico</p>
                </div>
                 <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100">
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-wide mb-2 flex items-center gap-1.5">
                        <CarIcon className="w-3.5 h-3.5" /> Carroceria
                    </p>
                    <p className="text-lg font-bold text-slate-800">{car.cat}</p>
                </div>
            </div>
            ...
            <div className="flex gap-3">
                <button 
                    ...
                    className={`flex-1 py-4 rounded-xl transition-all font-bold flex items-center justify-center gap-2 border-2 ${
                ...
                >
                 ...
                 <button 
                    ...
                    className={`w-14 py-4 rounded-xl transition-all font-bold flex items-center justify-center border-2 ${
                        isFavorite 
