...
export const CAR_DB: Car[] = [
  ...
  {
    model: "Haval H6 HEV ONE", brand: "GWM", price: 199900, range: 0, cat: "SUV",
    powertrain: 'HEV', fuelType2: 'flex',
    url: "https://www.gwmmotors.com.br/pt/experience/haval-h6",
    img: "/car-images/gwm-haval-h6-hev-one.webp",
    power: 248, torque: 54.5, battery: 1.53,
    features: [
  ...
  },
  {
    ...
    powertrain: 'HEV', fuelType2: 'flex',
    url: "https://www.gwmmotors.com.br/pt/experience/haval-h6",
    img: "/car-images/gwm-haval-h6.webp",
    power: 248, torque: 54.5, battery: 1.53,
    features: [
      "Híbrido pleno flex (sem tomada) — motor 1.5 turbo + elétrico, 248 cv / 54,5 kgfm",
      "15,8 km/l cidade (gasolina, Inmetro) com etanol ou gasolina",
  ...
  },
  {
    ...
    features: [
      ...
      "9 marchas (9HAT) e modos de terreno"
    ],
    energyMJkm: 1.07,
  ...
  },
  {
    ...
    features: [
      ...
      "Teto Wide Panorama, rodas 19\" e head-up display",
  ...
  },
  {
    ...
    features: [
      ...
      "Rodas 20\", som Sony 12 alto-falantes e fragrâncias L'Essence",
      "Tela central deslizante de 15,6\" 2.5K com Snapdragon 8155",
      "Pacote ADAS (ACC, AEB, ELK, BSD, RCTA, câmera 540°)"
    ],
    energyMJkm: 0.66,
  ...
  },
  {
    ...
    features: [
      ...
      "Painel flutuante 24,6\" (2x12,3\" curva)",
  ...
  },
  {
    ...
    features: [
      ...
      "6 airbags e pacote ADAS (ACC, AEB, LDW, BSD)"
    ],
    energyMJkm: 0.60,
    fuelConsumptionKml: 15.1,
  ...
  },
  {
    ...
    features: [
      ...
      "Som Sony com 8 alto-falantes; bancos aquecidos e iluminação ambiente",
  ...
  },
  {
    ...
    power: 262, torque: 38.7, battery: 18.4,
    features: [
      "SUV híbrido plug-in (1.5 a gasolina + elétricos) — 262 cv / 38,7 kgfm",
      "Bateria 18,4 kWh; autonomia elétrica PBEV de 65 km; combinada de 1.245 km",
      "14,6 km/l cidade (gasolina, Inmetro) no modo sustentação",
      "Recarga rápida DC 30 kW (30–80% em ~20 min) e V2L",
      "Central 15,4\" + painel 10,2\" com CarPlay e Android Auto sem fio",
      "6 airbags, ADAS nível 2 e câmera de ré"
    ],
    energyMJkm: 0.55,
    fuelConsumptionKml: 14.6,
    pbeRating: 'A',
    chargeDC: 30,
  ...
  },
  {
    ...
    features: [
      ...
      "14,6 km/l cidade (gasolina, Inmetro) no modo sustentação",
      "Recarga rápida DC 30 kW (30–80% em ~20 min) e V2L",
      "Teto solar panorâmico, HUD de 13,8\" e som com 16 alto-falantes",
      "Câmera 540°, bancos ventilados e rodas 19\""
    ],
    energyMJkm: 0.55,
    fuelConsumptionKml: 14.6,
    pbeRating: 'A',
  ...
  },
  {
    ...
    url: "https://www.geelybrasil.com.br/ex5-em-i",
    img: "/car-images/geely-ex5-emi.jpg",
    power: 262, torque: 38.7, battery: 29.8,
    features: [
      "SUV híbrido plug-in (1.5 a gasolina + elétricos) — 262 cv / 38,7 kgfm",
      "Bateria 29,8 kWh; autonomia elétrica PBEV de 112 km; combinada de 1.300 km",
      "14,8 km/l cidade (gasolina, Inmetro) no modo sustentação",
      "Recarga rápida DC 60 kW (30–80% em ~16 min) e V2L",
      "Teto solar panorâmico, HUD de 13,8\" e som com 16 alto-falantes",
      "Interior Caramel exclusivo e câmera 540°"
    ],
    energyMJkm: 0.59,
  ...
  },
  {
    ...
    features: [
      ...
      "Bateria Blade 13,1 kWh; autonomia elétrica PBEV de 57 km; combinada NEDC de até 1.075 km (gasolina)",
      "218 cv / 30,6 kgfm — 0–100 km/h em 8,6 s",
      "Carregamento AC 6,6 kW",
      "Central multimídia 12,8\" com Google Automotive, CarPlay e Android Auto sem fio",
      "6 airbags",
      "ADAS 2 com câmeras panorâmicas 360°",
      "Porta-malas de 530 L (1.482 L com bancos rebatidos)",
      "Função V2L (Vehicle-to-Load)",
      "Produção nacional (Camaçari - BA)"
    ],
    energyMJkm: 0.53,
    warrantyYears: 6, warrantyBatteryYears: 8, chargeAC: 6.6,
  ...
  },
  {
    ...
    features: [
      "Híbrido plug-in flex (DM-i 5ª geração) — roda com eletricidade, etanol ou gasolina",
      "Bateria Blade 18,3 kWh; autonomia elétrica PBEV de 72 km; combinada NEDC de até 1.105 km (gasolina)",
      "219 cv / 30,6 kgfm — 0–100 km/h em 8,8 s",
      "Carregamento AC 6,6 kW",
      "Central multimídia 12,8\" com Google Automotive, CarPlay e Android Auto sem fio",
  ...
  },
  {
    ...
    features: [
      ...
      "Bateria Blade 29,6 kWh; autonomia elétrica PBEV de 68 km; combinada NEDC de 730 km",
      "Carregamento AC 6,6 kW / DC 55 kW; tração elétrica inteligente nas 4 rodas",
      "Capacidade de reboque de 2.500 kg e carga de 790 kg; caçamba de 1.200 L",
      "Três modos de terreno (areia, lama e neve) + bloqueio virtual de diferencial",
      "Tela giratória 12,8\" com CarPlay e Android Auto + head-up display",
      "6 airbags",
      "Câmera panorâmica 540° (360° + 180° subchassi)",
      "Função VTOL (Vehicle-to-Load)"
    ],
    energyMJkm: 0.91,
    warrantyYears: 6, warrantyBatteryYears: 8, chargeAC: 6.6, chargeDC: 55,
  ...
  },
  {
    ...
    groundClearanceMm: 180, weightKg: 1970, trunkLiters: 552,
  ...
  },
  {
    ...
    features: [
      ...
      "Bateria Blade 26,6 kWh; autonomia elétrica PBEV de 87 km; combinada NEDC de até 1.015 km",
      "Carregamento AC 6,6 kW / DC 18 kW",
      "Central multimídia giratória 15,6\" + head-up display W-HUD",
      "Sistema de áudio Infinity com 10 alto-falantes",
      "Teto solar panorâmico com abertura elétrica",
      "6 airbags",
      "DiPilot: ACC + LCC + AEB + LKA + alerta de ponto cego",
      "Porta-malas de 552 L",
    ...
    warrantyYears: 6, warrantyBatteryYears: 8, chargeAC: 6.6, chargeDC: 18,
    lengthMm: 4780, widthMm: 1890, heightMm: 1670, wheelbaseMm: 2770,
    groundClearanceMm: 180, weightKg: 2060, trunkLiters: 552,
  ...
  },
  {
    ...
    features: [
      ...
      "Bateria Blade 8,3 kWh; autonomia elétrica PBEV de 35 km; combinada NEDC de até 1.175 km",
      "209 cv / 32,2 kgfm — 0–100 km/h em 7,9 s",
    ...
    energyMJkm: 0.53,
    warrantyYears: 6, warrantyBatteryYears: 8, chargeAC: 3.3,
    lengthMm: 4780, widthMm: 1840, heightMm: 1500, wheelbaseMm: 2720,
    groundClearanceMm: 170, weightKg: 1515, trunkLiters: 450,
  ...
  },
  {
    ...
    features: [
      "Sedã híbrido plug-in (DM-i) — roda com eletricidade ou gasolina",
      "Bateria Blade 18,3 kWh; autonomia elétrica PBEV de 78 km; combinada NEDC de até 1.200 km",
    ...
    warrantyYears: 6, warrantyBatteryYears: 8, chargeAC: 6.6,
    lengthMm: 4780, widthMm: 1840, heightMm: 1500, wheelbaseMm: 2720,
    groundClearanceMm: 170, weightKg: 1620, trunkLiters: 450,
  ...
  },
  {
    ...
    features: [
      ...
      "Câmbio Transaxle CVT",
      "Toyota Safety Sense e 7 airbags",
      "Rodas 17\", painel 12,3\" e bancos em couro",
      "Teto solar elétrico com antiesmagamento",
      "Garantia híbrida de 8 anos / 200.000 km"
    ],
    fuelConsumptionKml: 17.5,
    fuelConsumptionKmlEthanol: 12.5,
  ...
  },
  {
    ...
    features: [
      "SUV híbrido plug-in flex (DM-i 5ª geração) — roda com eletricidade, etanol ou gasolina",
      "Bateria Blade 18,03 kWh; autonomia elétrica PBEV de 75 km; combinada NEDC de até 1.045 km (gasolina)",
      "197 cv / 30,6 kgfm — 0–100 km/h em 8,4 s",
      "Carregamento AC 6,6 kW",
      "Central multimídia com Google Automotive, CarPlay e Android Auto",
      "Teto panorâmico",
      "6 airbags",
      "Pacote ADAS 2 (ACC, LKA, AEB, BSD)",
      "Porta-malas de 455 L (1.365 L rebatido)",
      "Função V2L (Vehicle-to-Load)",
      "Produção nacional (Camaçari - BA)"
    ],
    energyMJkm: 0.51,
  ...
  },
  {
    ...
    features: [
      "SUV híbrido plug-in de 7 lugares (DM-p 5.0, tração integral) — 488 cv / 68,9 kgfm, 0–100 km/h em 4,9 s",
      "Bateria Blade 35,6 kWh; autonomia elétrica PBEV de 111 km; combinada NEDC de 900 km",
      "Carregamento AC 6,6 kW / DC 72 kW",
      "Suspensão adaptativa DiSus-C; modos Eco/Normal/Sport/Neve",
      "Teto solar panorâmico de 2,39 m²; 9 airbags",
      "Sistema de áudio DiSound com 21 alto-falantes",
      "DiPilot: ACC + LCC + AEB + LKA + alerta de ponto cego",
      "Capacidade de carga de até 1.960 L com bancos rebatidos",
      "Função VTOL (Vehicle-to-Load)"
    ],
    energyMJkm: 0.71,
    warrantyYears: 6, warrantyBatteryYears: 8, chargeAC: 6.6, chargeDC: 72,
    lengthMm: 5040, widthMm: 2000, heightMm: 1760, wheelbaseMm: 2950,
    groundClearanceMm: 184, weightKg: 2625,
    fuelConsumptionKml: 11.4,
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      "Rodas 18\" — sem teto solar, HUD ou ponto cego",
      "Lexus Safety System+",
  ...
  },
  {
    ...
    features: [
      ...
      "Rodas 20\", head-up display e ponto cego",
      "Carregador portátil 2,3 kW + Wallbox 7,4 kW",
      "Bancos em couro com ventilação e memória",
      "Porta-malas de 520 L"
    ],
    energyMJkm: 0.61,
  ...
  },
  {
    ...
    features: [
      ...
      "Rodas 21\" F-Sport, suspensão AVS e direção traseira",
      "Mark Levinson 20+1 e bancos 10 posições",
      "Lexus Safety System+",
  ...
  },
  {
    ...
    features: [
      ...
      "14,8 km/l cidade (gasolina, Inmetro) no modo sustentação",
      "Tração integral AWD",
      "Bancos com ventilação nas duas fileiras e tomada 127 V",
      "Áudio Mark Levinson",
      "Porta-malas de 612 L"
    ],
    energyMJkm: 0.61,
  ...
  {
    model: "S06 Advance", brand: "Jetour", price: 199990, range: 70, cat: "SUV",
    powertrain: 'PHEV', electricRangeKm: 70, combinedRangeKm: 1200, fuelType2: 'gasolina',
    url: "https://jetourbr.com/carro/s06/",
    img: "/car-images/jetour-s06-phev.jpg",
    traction: 'FWD', battery: 19.4,
    features: [
      "SUV híbrido plug-in (1.5 turbo + elétrico)",
      "Bateria 19,4 kWh; autonomia elétrica PBEV de 70 km; combinada de 1.200 km",
      "14,0 km/l cidade (gasolina, Inmetro) no modo sustentação",
      "Recarga AC 6,6 kW / DC 40 kW",
      "Central multimídia 12,4\" com CarPlay e Android Auto sem fio",
      "Rodas 18\" e câmera 360°"
    ],
    energyMJkm: 0.62,
    fuelConsumptionKml: 14.0,
    pbeRating: 'A',
    chargeAC: 6.6, chargeDC: 40,
    warrantyYears: 7, warrantyBatteryYears: 8,
    lengthMm: 4616, widthMm: 1910, heightMm: 1690, wheelbaseMm: 2720, weightKg: 1746, trunkLiters: 416,
  },
  {
    model: "S06 Premium", brand: "Jetour", price: 229900, range: 70, cat: "SUV",
    powertrain: 'PHEV', electricRangeKm: 70, combinedRangeKm: 1200, fuelType2: 'gasolina',
    url: "https://jetourbr.com/carro/s06/",
    img: "/car-images/jetour-s06-phev.jpg",
    traction: 'FWD', battery: 19.4,
    features: [
      ...
      "14,0 km/l cidade (gasolina, Inmetro) no modo sustentação",
      "Recarga AC 6,6 kW / DC 40 kW",
      "Teto solar panorâmico e central de 15,6\"",
      "Som Sony com 9 alto-falantes e rodas 20\"",
      "ADAS nível 2 e bancos aquecidos e ventilados"
    ],
    energyMJkm: 0.62,
    fuelConsumptionKml: 14.0,
    pbeRating: 'A',
  ...
  {
    model: "T1 Advance", brand: "Jetour", price: 249900, range: 88, cat: "SUV",
    powertrain: 'PHEV', electricRangeKm: 88, combinedRangeKm: 1200, fuelType2: 'gasolina',
    url: "https://jetourbr.com/carro/t1/",
    img: "/car-images/jetour-t1-phev.jpg",
    traction: 'FWD', battery: 26.7,
    features: [
      "SUV híbrido plug-in (1.5 turbo + elétrico)",
      "Bateria 26,7 kWh; autonomia elétrica PBEV de 88 km; combinada de 1.200 km",
      "13,6 km/l cidade (gasolina, Inmetro) no modo sustentação",
      "Recarga AC 6,6 kW / DC 40 kW",
      "Central 15,6\" + cluster 10,25\" e rodas 19\"",
      "Pacote ADAS completo e bancos com ventilação"
    ],
    energyMJkm: 0.66,
    fuelConsumptionKml: 13.6,
    pbeRating: 'A',
    chargeAC: 6.6, chargeDC: 40,
    warrantyYears: 7, warrantyBatteryYears: 8,
    lengthMm: 4705, widthMm: 1967, heightMm: 1843, wheelbaseMm: 2800, weightKg: 2000, trunkLiters: 574,
  },
  {
    model: "T1 Premium", brand: "Jetour", price: 264900, range: 88, cat: "SUV",
    powertrain: 'PHEV', electricRangeKm: 88, combinedRangeKm: 1200, fuelType2: 'gasolina',
    url: "https://jetourbr.com/carro/t1/",
    img: "/car-images/jetour-t1-phev.jpg",
    traction: 'FWD', battery: 26.7,
    features: [
      ...
      "13,6 km/l cidade (gasolina, Inmetro) no modo sustentação",
      "Recarga AC 6,6 kW / DC 40 kW",
      "Teto solar panorâmico e porta-malas elétrico",
      "Som Sony com 9 alto-falantes e seletor em cristal",
      "Bancos com memória, Nap Mode e luz ambiente"
    ],
    energyMJkm: 0.66,
    fuelConsumptionKml: 13.6,
    pbeRating: 'A',
  ...
  {
    model: "T2 Advance", brand: "Jetour", price: 289900, range: 75, cat: "SUV",
    powertrain: 'PHEV', electricRangeKm: 75, combinedRangeKm: 1100, fuelType2: 'gasolina',
    url: "https://jetourbr.com/carro/t2/",
    img: "/car-images/jetour-t2-phev.jpg",
    power: 320, torque: 62.2, traction: 'FWD', battery: 26.7,
    features: [
      "SUV híbrido plug-in (1.5 turbo + 2 elétricos) — 320 cv / 62,2 kgfm",
      "Bateria 26,7 kWh; autonomia elétrica PBEV de 75 km; combinada de 1.100 km",
      "11,4 km/l cidade (gasolina, Inmetro) no modo sustentação",
      "Recarga AC 7 kW / DC 40 kW",
      "Central 15,6\" + cluster 10,25\", rodas 19\" e câmera 540°",
      "Bancos com ventilação e pacote ADAS completo"
    ],
    energyMJkm: 0.80,
    fuelConsumptionKml: 11.4,
    pbeRating: 'A',
    chargeAC: 7, chargeDC: 40,
    warrantyYears: 7, warrantyBatteryYears: 8,
    lengthMm: 4785, widthMm: 2006, heightMm: 1875, wheelbaseMm: 2800, weightKg: 2110, trunkLiters: 580,
  },
  {
    model: "T2 Premium", brand: "Jetour", price: 299900, range: 75, cat: "SUV",
    powertrain: 'PHEV', electricRangeKm: 75, combinedRangeKm: 1100, fuelType2: 'gasolina',
    url: "https://jetourbr.com/carro/t2/",
    img: "/car-images/jetour-t2-phev.jpg",
    power: 320, torque: 62.2, traction: 'FWD', battery: 26.7,
    features: [
      ...
      "11,4 km/l cidade (gasolina, Inmetro) no modo sustentação",
      "Recarga AC 7 kW / DC 40 kW",
      "Teto solar panorâmico e tampa traseira elétrica",
      "Som Sony com 12 alto-falantes e rodas 20\"",
      "Banco do motorista com memória e soleira iluminada"
    ],
    energyMJkm: 0.80,
    fuelConsumptionKml: 11.4,
    pbeRating: 'A',
  ...
  {
    model: "T2 4x4", brand: "Jetour", price: 349900, range: 106, cat: "SUV",
    powertrain: 'PHEV', electricRangeKm: 106, combinedRangeKm: 1300, fuelType2: 'gasolina',
    url: "https://jetourbr.com/carro/t2-4x4/",
    img: "/car-images/jetour-t2-4x4.jpg",
    traction: 'AWD', battery: 43.2,
    features: [
      "SUV híbrido plug-in (1.5 turbo + 3 elétricos) com tração integral inteligente XWD",
      "Bateria 43,2 kWh; autonomia elétrica PBEV de 106 km; combinada de 1.300 km",
      "10,5 km/l cidade (gasolina, Inmetro) no modo sustentação",
      "Recarga AC/DC (DC 30–80% em 37 min) e V2L",
      "8 modos de condução, bloqueio do diferencial traseiro e Tank Turn",
      "Central 15,6\", som Sony com 12 alto-falantes e teto solar panorâmico"
    ],
    energyMJkm: 0.84,
    fuelConsumptionKml: 10.5,
    pbeRating: 'A',
    warrantyYears: 7, warrantyBatteryYears: 8,
    lengthMm: 4785, widthMm: 2006, heightMm: 1875, wheelbaseMm: 2800,
  },
