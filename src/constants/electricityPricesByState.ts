...
export const ELECTRICITY_PRICES_UPDATED = 'jul de 2026';
...
export const ELECTRICITY_PRICES_BY_STATE: Record<string, number> = {
  ...
  RO: 0.84, // Energisa RO + Eletrobras RO (média)
  RR: 0.79, // Boa Vista Energia (+22,90% jan/2026)
  RS: 0.88, // CEEE-D + RGE (~60% do estado)
  SC: 0.70, // CELESC (~95% do estado)
  SE: 0.75, // Energisa SE + Sulgipe (média, +5% abr/2026)
  SP: 0.78, // Média de 7 distribuidoras (Enel SP +9,02% jul/2026, EDP, CPFL, Elektro…)
  TO: 1.01, // Energisa TO
};
