...
export const IPVA_BY_STATE: IpvaStateInfo[] = [
  { abbr: 'AC', name: 'Acre',                  bevRate: 0,     standardRate: 0.03,  condition: null },
  ...
  { abbr: 'BA', name: 'Bahia',                 bevRate: 0,     standardRate: 0.03,  condition: null, exemptionThreshold: 300000 },
  ...
  { abbr: 'ES', name: 'Espírito Santo',        bevRate: 0.02,  standardRate: 0.04,  condition: null },
  { abbr: 'GO', name: 'Goiás',                 bevRate: 0.03,  standardRate: 0.03,  condition: null },
  ...
  { abbr: 'MS', name: 'Mato Grosso do Sul',    bevRate: 0,     standardRate: 0.035, condition: 'Isenção no 1º ano; 70% desc. após' },
  { abbr: 'MT', name: 'Mato Grosso',           bevRate: 0.03,  standardRate: 0.03,  condition: null },
  { abbr: 'PA', name: 'Pará',                  bevRate: 0,     standardRate: 0.03,  condition: null, exemptionThreshold: 150000 },
  { abbr: 'PB', name: 'Paraíba',               bevRate: 0,     standardRate: 0.03,  condition: null },
  { abbr: 'PE', name: 'Pernambuco',            bevRate: 0,     standardRate: 0.03,  condition: null },
  { abbr: 'PI', name: 'Piauí',                 bevRate: 0.01,  standardRate: 0.03,  condition: null },
  { abbr: 'PR', name: 'Paraná',                bevRate: 0.019, standardRate: 0.035, condition: null },
  ...
  { abbr: 'SC', name: 'Santa Catarina',        bevRate: 0.03,  standardRate: 0.03,  condition: null },
  ...
  { abbr: 'TO', name: 'Tocantins',             bevRate: 0,     standardRate: 0.03,  condition: null },
];
