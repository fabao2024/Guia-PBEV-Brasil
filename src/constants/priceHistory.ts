...
export const PRICE_HISTORY: Record<string, PriceSnapshot[]> = {
  ...
  "Dolphin Mini GL": [{ date: '2026-03', price: 118990 }, { date: '2026-08', price: 109990 }],
  "EX2 Max": [{ date: '2026-03', price: 135100 }, { date: '2026-07', price: 136800 }],
  "EX2 Pro": [{ date: '2026-07', price: 123800 }],
  ...
  "Cooper E": [{ date: '2026-03', price: 260990 }, { date: '2026-08', price: 264990 }],
  "JCW-E": [{ date: '2026-03', price: 330990 }, { date: '2026-08', price: 349990 }],
  "Aceman SE": [{ date: '2026-03', price: 304990 }, { date: '2026-08', price: 325990 }],
  "Dolphin Plus": [{ date: '2026-03', price: 184000 }, { date: '2026-06', price: 179800 }, { date: '2026-08', price: 184800 }],
  "Aion ES": [{ date: '2026-03', price: 170990 }],
  "Yuan Pro": [{ date: '2026-03', price: 182900 }, { date: '2026-08', price: 182990 }],
  "Aion Y Elite": [{ date: '2026-03', price: 184900 }, { date: '2026-05', price: 187990 }],
  "Aion V Elite": [{ date: '2026-03', price: 219000 }, { date: '2026-08', price: 219990 }],
  ...
  "EX5 Max": [{ date: '2026-03', price: 215800 }, { date: '2026-08', price: 225800 }],
  "Kona EV": [{ date: '2026-03', price: 219990 }],
  "Yuan Plus": [{ date: '2026-03', price: 229800 }],
  "Yuan Plus AWD": [{ date: '2026-04', price: 269990 }],
  "EX30 Plus": [{ date: '2026-03', price: 229950 }, { date: '2026-04', price: 239950 }, { date: '2026-08', price: 249950 }],
  "EX30 Ultra": [{ date: '2026-04', price: 309950 }, { date: '2026-08', price: 319950 }],
  "e-2008": [{ date: '2026-03', price: 269990 }],
  "Megane E-Tech": [{ date: '2026-03', price: 279900 }],
  "Countryman SE": [{ date: '2026-03', price: 340990 }, { date: '2026-08', price: 409990 }],
  "Equinox EV": [{ date: '2026-03', price: 349990 }],
  "ID.4": [{ date: '2026-03', price: 320000 }],
  "EX40 (XC40)": [{ date: '2026-03', price: 342950 }, { date: '2026-08', price: 329950 }],
  "EC40 (C40)": [{ date: '2026-03', price: 359950 }, { date: '2026-08', price: 334950 }],
  "EX90 Twin": [{ date: '2026-03', price: 849990 }, { date: '2026-08', price: 849950 }],
  "iX2 xDrive30": [{ date: '2026-03', price: 495950 }],
  "iX1 eDrive20": [{ date: '2026-03', price: 359950 }],
  "EV5 Land": [{ date: '2026-03', price: 389990 }],
  "Ioniq 5": [{ date: '2026-03', price: 394990 }, { date: '2026-08', price: 409990 }],
  ...
  "Ora 5": [{ date: '2026-06', price: 159000 }, { date: '2026-08', price: 163990 }],
  ...
  "Seal AWD": [{ date: '2026-03', price: 249990 }, { date: '2026-06', price: 269990 }, { date: '2026-08', price: 299990 }],
  "001 Premium": [{ date: '2026-03', price: 428000 }],
  "i4 eDrive35": [{ date: '2026-03', price: 449950 }],
  "Mustang Mach-E": [{ date: '2026-03', price: 486000 }],
  "Blazer EV RS": [{ date: '2026-03', price: 489000 }, { date: '2026-08', price: 503190 }],
  "Tan EV": [{ date: '2026-03', price: 529800 }, { date: '2026-06', price: 536800 }],
  "Han EV": [{ date: '2026-03', price: 539800 }, { date: '2026-06', price: 559800 }],
  "Macan EV": [{ date: '2026-03', price: 560000 }, { date: '2026-08', price: 690000 }],
  "Q8 e-tron": [{ date: '2026-03', price: 699000 }],
  "A6 Sportback e-tron": [{ date: '2026-03', price: 649990 }],
  "Q6 e-tron": [{ date: '2026-03', price: 529990 }, { date: '2026-08', price: 695990 }],
  "Q6 Sportback e-tron": [{ date: '2026-03', price: 569990 }, { date: '2026-08', price: 710990 }],
  "SQ6 Sportback e-tron": [{ date: '2026-03', price: 684990 }, { date: '2026-08', price: 790990 }],
  "iX xDrive40": [{ date: '2026-03', price: 699950 }],
  "i5 M60": [{ date: '2026-03', price: 794950 }],
  "Taycan 4S": [{ date: '2026-03', price: 745000 }, { date: '2026-04', price: 980000 }, { date: '2026-08', price: 1080000 }],
  "EV9 GT-Line": [{ date: '2026-03', price: 749990 }],
  "Hyptec HT": [{ date: '2026-03', price: 359990 }, { date: '2026-08', price: 314990 }],
  "e-tron GT": [{ date: '2026-03', price: 769990 }],
  "i7 xDrive60": [{ date: '2026-03', price: 1321950 }, { date: '2026-08', price: 1373950 }],
  ...
  "MG4 Comfort": [{ date: '2026-03', price: 164600 }, { date: '2026-08', price: 184600 }],
  "MG4 Luxury": [{ date: '2026-03', price: 189800 }, { date: '2026-08', price: 199800 }],
  "MG4 XPower": [{ date: '2026-03', price: 229800 }],
  "MGS5 Comfort": [{ date: '2026-03', price: 195800 }, { date: '2026-08', price: 218800 }],
  "MGS5 Luxury": [{ date: '2026-03', price: 219800 }, { date: '2026-08', price: 238800 }],
  ...
  "EX5 Pro": [{ date: '2026-07', price: 195800 }, { date: '2026-08', price: 205800 }],
