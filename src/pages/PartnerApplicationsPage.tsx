...
function createInitialForm(): PartnerApplicationFormData {
  return {
    ...
    notes: '', lgpdAcceptance: false, termsVersion: '2026-07-29-pilot-v1',
  };
}
    ...
    <main className="min-h-screen bg-[#05070d] text-white px-5 py-8">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <section className="relative overflow-hidden rounded-[2rem] border border-[#00b4ff]/20 bg-gradient-to-br from-[#07111f] via-[#070a12] to-[#002b44] p-6 md:p-10 mb-8">
          <div className="relative max-w-4xl">
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4"><strong className="text-2xl text-[#37f29b]">3</strong><p className="mt-1 text-sm text-white/60">leads aceitos no piloto gratuito</p></div>
        ...
        <section className={`${cardClass} mb-8`}>
          ...
          <p className="mt-3 text-white/65">Wallbox e energia solar participam do piloto gratuito em SP. Seguro EV, financiamento, compra de veículos, frotas e documentação permanecem em formação. A operação começa manual, limitada a até 3 leads aceitos por parceiro e sem promessa de volume ou conversão.</p>
        </section>
      </div>
    </main>
  );
